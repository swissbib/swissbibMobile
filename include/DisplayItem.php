...
function displayItem($id, $network=false, $library=false, $language='en')
{
	...
	$lookuptable=array(
		...
		"E02HC" => "Sciences humaines. Dictionnaires et normes",
		"E02IA" => "Sciences pour tous",
		"E02IB" => "Sciences pour tous. Espace Découverte",
		"E02IC" => "Sciences pour tous. Magazines",
		"E02ID" => "Sciences pour tous. Périodiques architecture",
		"E02IN" => "Administration bibliothèque. S'adresser au guiche",
		...
		"E02PL" => "Sous-sol. B123-B125. Périodiques sciences crimine",
		...
		"E02SG" => "Sous-sol. B100-B101. Thèses, trav.dipl. et prépu",
		"E02SP" => "Sous-sol. B97-B99. Polycopiés",
		"E02XA" => "Sous-sol. A101-106. Dépôt légal",
		"E02XB" => "Sous-sol. A109-A110. Fonds XIXe. S'adresser au gui",
		"E02XC" => "Sous-sol. A111-A114. Fonds spéciaux. S'adresser a",
		"E02XE" => "Sous-sol. A116-A121. Divers. S'adresser au guichet",
		"E02XF" => "Sous-sol. N4-N17. Grands formats. S'adresser au gu",
		"E02XG" => "Sous-sol. Stock",
		"E02ZA" => "Dépôt externe. Fonds réservé IGAT. Prêt et co",
		"E02ZB" => "Dépôt externe. Faculté des Sciences de la vie.",
		"E02ZC" => "Dépôt externe. IPSB-LCB. Prêt et consultation e",
		"LACC" => "Unbekannt-E02,LACC",
